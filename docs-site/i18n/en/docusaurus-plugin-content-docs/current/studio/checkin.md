...
1. Choose the student — they have to be connected to this device
2. Check the course and the date
3. **Redeem**

The app shows the balance and, next to it, **when this device last saw anything
...
happened since last time — including redemptions from the other location. The
student is the courier. That is why the desk at West sees the check-in from the
old town as soon as the same person walks in, without the two counters ever
...
never twice — a contradiction never costs more than one class, and never gives one
away.
